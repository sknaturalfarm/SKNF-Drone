            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className={`fade-in ${isVisible ? "visible" : ""}`}>
                ...
                <p className={`text-xl ${themeClasses.textSecondary} mb-2`}>
                  For Moderate Operations
                </p>
                <p
                  className={`text-lg ${themeClasses.textTertiary} mb-8 leading-relaxed`}
                >
                  Experience reliable aerial technology with balanced
                  performance, steady control, and versatile capabilities
                  designed for efficient operations across various applications.
                </p>
                ...
                <div className="relative mt-10 flex justify-center">
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      >
                        Built for reliable and efficient operations
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section id="video" className="py-16 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              >
                Watch how Omega Core delivers reliable aerial operations with
                steady control and versatile capabilities
              </p>
            </div>
      ...
      <p className="text-xs md:text-sm">Control Range</p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p
                className={`text-xl ${themeClasses.textSecondary} max-w-2xl mx-auto`}
              >
                Every feature engineered for consistent performance and
                  ...
                  {[
                    {
                      ...
                      description:
                        "Secure digital interface with reliable flight control systems for consistent operations",
                    },
                    {
                      icon: "⏱️",
                      title: "35 Min Flight",
                      description:
                        "Extended battery performance optimized for moderate to long-duration missions",
                    },
                    {
                      icon: "💪",
                      title: "15kg Payload",
                      description:
                        "Enhanced lifting capacity suitable for various equipment and operational requirements",
                    },
                    {
                      icon: "📡",
                      title: "600m Range",
                      description:
                        "Extended operational range with stable communication and reliable data transmission",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
                  ...
                  {[
                    {
                      ...
                      description:
                        "Reliable crop monitoring, field analysis, and agricultural support with moderate precision sensors",
                      image: "/agri_monitoring.webp",
                    },
                    {
                      title: "General Surveillance",
                      description:
                        "Versatile monitoring operations with steady performance for various security applications",
                      image: "/security & Survillance.png",
                    },
                    {
                      title: "Maintenance Support",
                      description:
                        "Infrastructure inspection and maintenance assistance with reliable operational capabilities",
                      image: "/ZHU-52.jpg",
                    },
                  ].map((app, index) => (
                    <div
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <p className={themeClasses.textSecondary}>
                    Ideal for farm operations and crop management
                  </p>
                </div>
              ...
              >
                ...
                <div className="text-center mb-6 mt-4">
                  ...
                  <p className={themeClasses.textSecondary}>
                    Versatile package for various applications
                  </p>
                </div>
                <ul className="space-y-3 mb-8">
                  <li
            ...
            <div className="text-center mt-8">
              <p className={themeClasses.textTertiary}>
                * Fixed pay model with transparent pricing. Includes 2-year
        ...
        <section className="py-20 px-6 text-center">
          ...
          >
            ...
            >
              Join operators worldwide who rely on Omega Core for their everyday
              missions. Experience reliable aerial technology with balanced
              performance.
            </p>
