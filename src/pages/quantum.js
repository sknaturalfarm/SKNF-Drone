    ...
    SK Natural Farm
              ...
              <div className="flex items-center space-x-8">
                <div className="hidden md:flex space-x-8">
                  <Link href="/" className={`${themeClasses.textSecondary} hover:${themeClasses.accent} transition-colors font-medium`}>
                    Home
                  </Link>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className={`fade-in ${isVisible ? 'visible' : ''}`}>
                ...
                <p className={`text-xl ${themeClasses.textSecondary} mb-2`}>Professional Use</p>
                <p className={`text-lg ${themeClasses.textTertiary} mb-8 leading-relaxed`}>
                  Experience cutting-edge aerial technology with advanced automation, 
                  exceptional performance, and professional-grade capabilities designed 
                  for the most demanding operations and specialized missions.
                </p>
              ...
              <div className={`fade-in ${isVisible ? 'visible' : ''} relative`} style={{animationDelay: '0.3s'}}>
                <div className={`relative h-96 glassmorphism ${themeClasses.card} rounded-3xl overflow-hidden hover-glow transition-all duration-500`}>
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    ...
                    <p className={themeClasses.textSecondary}>Built for advanced operations and maximum performance</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className={`text-xl ${themeClasses.textSecondary} max-w-2xl mx-auto`}>
                Watch how Quantum Pro delivers exceptional aerial operations with fully automatic control
              ...
              <div className="aspect-video relative">
                ...
                >
                  ...
                  <p className={`${themeClasses.text} p-8`}>
                    ...
                    <a href="/videos/drone2.mp4" className={`${themeClasses.accent} underline`}>
                      Download the video
                    </a>
                  </p>
                </video>
              ...
              <div className="p-8">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    <div className={`text-3xl font-black ${themeClasses.accent} mb-2`}>50min</div>
                    <p className={themeClasses.textSecondary}>Flight Duration</p>
                  </div>
                  <div className="text-center">
                    <div className={`text-3xl font-black ${themeClasses.accent} mb-2`}>27kg</div>
                    <p className={themeClasses.textSecondary}>Max Payload</p>
                  </div>
                  <div className="text-center">
                    <div className={`text-3xl font-black ${themeClasses.accent} mb-2`}>1000m</div>
        ...
        <section id="features" className="py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className={`text-xl ${themeClasses.textSecondary} max-w-2xl mx-auto`}>
                Every feature engineered for professional excellence and cutting-edge performance
              </p>
            </div>
                  ...
                  {[
                    {
                      ...
                      description: 'Advanced AI-powered autonomous flight systems with intelligent navigation and obstacle avoidance'
                    },
                    {
                      icon: '⏱️',
                      title: '50 Min Flight',
                      description: 'Superior battery technology optimized for extended professional missions and complex operations'
                    },
                    {
                      icon: '💪',
                      title: '27kg Payload',
                      description: 'Maximum lifting capacity for heavy professional equipment and specialized payload requirements'
                    },
                    {
                      icon: '📡',
                      title: '1000m Range',
                      description: 'Ultra-long-range operation with advanced communication systems and real-time data transmission'
                    }
                  ].map((feature, index) => (
                  ...
                  {[
                    {
                      ...
                      description: 'Advanced crop monitoring, precision spraying, and agricultural analytics with professional-grade sensors',
                      image: '/agri_monitoring.webp'
                    },
                    {
                      title: 'Professional Surveillance',
                      description: 'High-end security operations with advanced monitoring capabilities and intelligent threat detection',
                      image: '/security & Survillance.png'
                    },
                    {
                      title: 'Industrial Inspection',
                      description: 'Professional infrastructure inspection and maintenance with advanced imaging and analysis capabilities',
                      image: '/ZHU-52.jpg'
                    }
                  ].map((app, index) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className={`glassmorphism ${themeClasses.card} rounded-2xl p-8 hover-glow transition-all`}>
                <div className="text-center mb-6">
                  <h3 className={`text-2xl font-bold ${themeClasses.accent} mb-2`}>Agricultural Professional</h3>
                  <div className={`text-4xl font-black gradient-text mb-2`}>₹2013.86</div>
                  <p className={themeClasses.textSecondary}>Advanced package for precision agriculture</p>
                </div>
              ...
              <div className={`glassmorphism ${themeClasses.card} rounded-2xl p-8 hover-glow transition-all relative`}>
                ...
                <div className="text-center mb-6 mt-4">
                  <h3 className={`text-2xl font-bold ${themeClasses.accent} mb-2`}>Enterprise Operations</h3>
                  <div className={`text-4xl font-black gradient-text mb-2`}>₹1963.86</div>
                  <p className={themeClasses.textSecondary}>Complete enterprise solution package</p>
                </div>
                <ul className="space-y-3 mb-8">
                  <li className={`flex items-center ${themeClasses.textSecondary}`}>
                    <span className="text-green-500 mr-3">✓</span>
            ...
            <div className="text-center mt-8">
              <p className={themeClasses.textTertiary}>
                * Fixed rate model with premium features. Includes 3-year warranty and professional support.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 text-center">
          <div className={`max-w-4xl mx-auto glassmorphism ${themeClasses.card} rounded-3xl p-12`}>
            ...
            <p className={`text-xl ${themeClasses.textSecondary} mb-8 max-w-2xl mx-auto`}>
              Join professionals worldwide who trust Quantum Pro for their most critical missions.
              Experience the future of autonomous aerial technology.
            </p>
