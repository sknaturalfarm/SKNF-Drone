      ...
      >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className={`fade-in ${isVisible ? "visible" : ""}`}>
                ...
                >
                  Experience the future of aerial technology with cutting-edge
                  precision, unmatched reliability, and professional-grade
                  performance that elevates every mission to new heights.
                </p>
        ...
        <section id="video" className="py-20 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              >
                Watch how Alpha Mode transforms aerial operations with precision
                  ...
                  {[
                    {
                      ...
                      description:
                        "Precision control with advanced flight algorithms for professional maneuvering",
                    },
                    {
                      icon: "⏱️",
                      title: "15 Min Flight",
                      description:
                        "Extended battery life optimized for maximum operational efficiency",
                    },
                    {
                      icon: "💪",
                      title: "10kg Payload",
                      description:
                        "Heavy-duty lifting capacity for professional equipment and cargo",
                    },
                    {
                      icon: "📡",
                      title: "400m Range",
                      description:
                        "Long-range operation with stable communication and video transmission",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
                  ...
                  {[
                    {
                      ...
                      description:
                        "Precision crop monitoring, pest detection, and field analysis with advanced sensors",
                      image: "/agri_monitoring.webp",
                    },
                    {
                      title: "Security & Surveillance",
                      description:
                        "Professional security operations with real-time monitoring and threat assessment",
                      image: "/security & Survillance.png",
                    },
                    {
                      title: "Industrial Inspection",
                      description:
                        "Infrastructure inspection, maintenance support, and safety compliance monitoring",
                      image: "/ZHU-52.jpg",
                    },
                  ].map((app, index) => (
                    <div
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <p className={themeClasses.textSecondary}>
                    Perfect for farm monitoring and crop analysis
                  </p>
                </div>
              ...
              >
                ...
                <div className="text-center mb-6 mt-4">
                  ...
                  <p className={themeClasses.textSecondary}>
                    Enhanced security and tactical operations
                  </p>
                </div>
                <ul className="space-y-3 mb-8">
                  <li
            ...
            <div className="text-center mt-8">
              <p className={themeClasses.textTertiary}>
                * Fixed pay model with no hidden fees. Includes 2-year warranty
        ...
        <section className="py-20 px-6 text-center">
          ...
          >
            ...
            >
              Join professionals worldwide who trust Alpha Mode for their most
              critical missions. Experience the future of aerial technology
              today.
            </p>
